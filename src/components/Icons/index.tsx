...
export function NotificationsFill() {
  return (
    <svg className="svg_icons" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.88 14.95L20.48 14.54C20.22 14.27 19.98 14 19.76 13.73C19.57 13.49 19.4 13.27 19.26 13.07C19.07 12.79 19 12.62 18.97 12.54C18.93 12.45 18.82 12.09 18.74 11.12C18.69 10.51 18.67 9.81 18.68 9.12C18.68 9.05 18.68 8.97 18.68 8.87C18.68 5.22 15.68 2.25 12 2.25C8.32 2.25 5.32 5.23 5.32 8.89V9.11C5.33 9.82 5.31 10.51 5.26 11.13C5.19 12.1 5.07 12.47 5.03 12.55C5 12.63 4.92 12.8 4.74 13.07C4.6 13.27 4.44 13.49 4.24 13.73C4.02 14 3.78 14.27 3.52 14.54L3.17 14.9C2.78 15.27 2.56 15.78 2.56 16.32V17.1C2.56 17.96 3.26 18.65 4.12 18.65H8.23C8.58 20.41 10.14 21.75 12.01 21.75C13.88 21.75 15.44 20.42 15.79 18.65H19.9C20.76 18.65 21.46 17.95 21.46 17.1V16.32C21.44 15.78 21.22 15.26 20.88 14.95ZM12 20.25C10.97 20.25 10.1 19.58 9.78 18.65H14.22C13.9 19.58 13.03 20.25 12 20.25Z" fill="#666666" className="icon_svg-fill_as_stroke"></path></svg>
  );
}
...
export function AlphabetIcon(){
  return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path className="icon_svg-fill_as_stroke" d="m10.526 17.352-1.002-3.031H5.162l-1.018 3.031H2L6.205 5.5h2.382l4.214 11.852h-2.275zM7.281 7.759l-1.626 4.887h3.376l-1.61-4.887h-.14zm10.415 8.14c1.232 0 2.152-.797 2.152-1.84v-.715l-2.029.131c-1.142.074-1.676.485-1.676 1.216 0 .756.649 1.207 1.552 1.207zm-.6 1.602c-1.733 0-2.973-1.051-2.973-2.694 0-1.626 1.224-2.563 3.409-2.694l2.316-.14v-.756c0-.879-.591-1.372-1.692-1.372-.936 0-1.577.329-1.766.936h-1.922c.164-1.585 1.651-2.595 3.786-2.595 2.308 0 3.606 1.125 3.606 3.031v6.136h-1.963V16.12h-.14c-.501.871-1.487 1.38-2.661 1.38z" fill="#666" fillRule="evenodd"></path></svg>
}
export function GalleryIcon(){
  return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24"><defs><path d="M5 4.5v14H2V.5h16.5v4H5z" id="a"></path></defs><g fill="#666" fillRule="evenodd" className="icon_svg-fill_as_stroke"><g fillRule="nonzero"><path d="M8 7a.5.5 0 0 0-.5.5v12a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5v-12A.5.5 0 0 0 20 7H8zm0-1.25h12a1.75 1.75 0 0 1 1.75 1.75v12A1.75 1.75 0 0 1 20 21.25H8a1.75 1.75 0 0 1-1.75-1.75v-12A1.75 1.75 0 0 1 8 5.75zM17.5 9a1 1 0 1 0 0 2 1 1 0 1 0 0-2zm0-1.25a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 1 1 0-4.5z"></path><path d="M7.511 16.316V20h13v-3.682c-1.73-.926-2.81-1.389-3.241-1.389-.647 0-2.606 1.388-3.257 1.389s-2.609-2.299-3.252-2.299c-.429 0-1.512.766-3.25 2.298zm6.674-1.353.867-.443c1.296-.69 1.629-.842 2.217-.842.732 0 1.874.489 3.831 1.537a1.25 1.25 0 0 1 .66 1.102V20a1.25 1.25 0 0 1-1.25 1.25h-13A1.25 1.25 0 0 1 6.261 20v-3.684a1.25 1.25 0 0 1 .423-.938c2.065-1.82 3.183-2.61 4.077-2.61.523 0 .911.21 1.443.613.271.205.489.392 1.007.849l.866.732.041.031.067-.03z"></path></g><mask id="b" fill="#fff"><use xlinkHref="#a"></use></mask><path d="M4.5 3.5A.5.5 0 0 0 4 4v12a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5V4a.5.5 0 0 0-.5-.5h-12zm0-1.25h12A1.75 1.75 0 0 1 18.25 4v12a1.75 1.75 0 0 1-1.75 1.75h-12A1.75 1.75 0 0 1 2.75 16V4A1.75 1.75 0 0 1 4.5 2.25z" fillRule="nonzero" mask="url(#b)"></path></g></svg>
}
export function UpVoteFill(){
  return <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path  d="M12 4 3 15h6v5h6v-5h6z" className="icon_svg-stroke icon_svg-fill" strokeWidth="1.5" stroke="#666" fill="rgb(46, 105, 255)" strokeLinejoin="round"></path></svg>
}
export function DownVoteFill(){
  return <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m12 20 9-11h-6V4H9v5H3z" className="icon_svg-fill" stroke="rgb(203, 75, 16)" fill="rgb(203, 75, 16)" strokeWidth="1.5" strokeLinejoin="round"></path></svg>
}